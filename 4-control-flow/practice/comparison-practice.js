...
const threeGreater = 3 > 2;

console.log(`Is 3 > 2 ? ${threeGreater}`);

// Reverse the prior statement and check if 3 is less than 2
const threeLesser = 3 < 2;

console.log(`Is 3 < 2 ? ${threeLesser}`);
// Check if 4 is less than or equal to 4.4
const fourLesser = 4 <= 4.4;

console.log(`Is 4 < 4.4 ? ${fourLesser}`);
// Reverse the prior statement and check if 4 is greater than or equal to 4.4
const fourGreater = 4 > 4.4;

console.log(`Is 4 > 4.4 ? ${fourGreater}`);

// Check if the string value of 19 is greater than the numeric value of 2
const stringGreater = "19" > 2;

console.log(`Is "19" greater than 2 ? ${stringGreater}`);
